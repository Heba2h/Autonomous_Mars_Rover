...
def forward(Rover, speed, desired_speed,steer, can_move):
    # moves the rover forward
    if can_move:
        if Rover.vel < Rover.max_vel:
            # Set throttle value to controlled throttle setting
            longitudunal_Control = pid.get_longitudinal_control(np.array([Rover.pos[0],Rover.pos[1],Rover.nav_angles,speed]),desired_speed,(1/25))
